...
public class Keyboard
{
    ...
    {
        keyEvents[queue.GetNextPos()] = KeyCodes.ToOnion3DKey(key);
    ...
    {
        int index = KeyCodes.ToOnion3DKey(key);
    ...
    {
        //TODO: Keyboard.poll() is not implemented
    }

    public static void EnableRepeatEvents(boolean enable)
    {
        //TODO: Keyboard.enableRepeatEvents(boolean) is not implemented
    }

    public static boolean IsRepeatEvent()
    {
        //TODO: Keyboard.isRepeatEvent() is not implemented
        return false;
    }
