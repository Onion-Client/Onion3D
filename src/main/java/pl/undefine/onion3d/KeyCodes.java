...
{
    public static int ToOnion3DKey(int glfwKeyCode)
    {
        switch (glfwKeyCode)
        {
            ...
            case GLFW.GLFW_KEY_WORLD_1:
                return Keyboard.KEY_CIRCUMFLEX; // TODO not sure if correct
            ...
            default:
                LogManager.getRootLogger().warn("[Onion3D] Unknown GLFW key code: {}", glfwKeyCode);
    ...
    public static int ToGLFWKey(int lwjglKeyCode)
    {
        switch (lwjglKeyCode)
        {
            ...
            default:
                LogManager.getRootLogger().warn("[Onion3D] Unknown LWJGL key code: {}", lwjglKeyCode);
